...
from robosat.osm.not_building import NotBuildingHandler
...
handlers = {"not_building": NotBuildingHandler, "parking": ParkingHandler, "building": BuildingHandler, "road": RoadHandler}
